---
name: rust-understanding-pointers
description: "Thread safety, Send/Sync, pointer types, Arc/Rc/Box \u2014 memahami pointer dan concurrency di Rust."
version: 1.0.0
category: general
status: published
confidence: 0.9
...
> **Source:** Apollo GraphQL's [Rust Best Practices Handbook](https://github.com/apollographql/rust-best-practices) — Chapter 9.
