---
name: rust-automated-testing
description: "Test naming, one assertion per test, snapshot testing, doc tests \u2014 automated testing best practices Rust."
version: 1.0.0
category: general
status: published
confidence: 0.9
...
> **Source:** Apollo GraphQL's [Rust Best Practices Handbook](https://github.com/apollographql/rust-best-practices) — Chapter 5.
