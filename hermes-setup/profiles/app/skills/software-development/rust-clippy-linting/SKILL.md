...
description: "Clippy configuration, important lints, workspace lint setup \u2014 disiplin linting untuk Rust code quality."
version: 1.0.0
category: general
status: published
confidence: 0.9
...
> **Source:** Apollo GraphQL's [Rust Best Practices Handbook](https://github.com/apollographql/rust-best-practices) — Chapter 2.
