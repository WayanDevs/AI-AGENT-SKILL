---
name: rust-type-state-pattern
description: "Compile-time state safety, PhantomData, when to use type state \u2014 encode valid states di type system Rust."
version: 1.0.0
category: general
status: published
confidence: 0.9
...
> **Source:** Apollo GraphQL's [Rust Best Practices Handbook](https://github.com/apollographql/rust-best-practices) — Chapter 7.
