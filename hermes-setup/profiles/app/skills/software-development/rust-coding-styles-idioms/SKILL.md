---
name: rust-coding-styles-idioms
description: "Borrowing vs cloning, Copy trait, Option/Result handling, iterators, comments \u2014 coding styles dan idioms Rust idiomatic."
version: 1.0.0
category: general
status: published
confidence: 0.9
...
> **Source:** Apollo GraphQL's [Rust Best Practices Handbook](https://github.com/apollographql/rust-best-practices) — Chapter 1.
> **Related skills:** `rust-best-practices` (overview), `rust-programming-expert`
